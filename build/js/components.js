...
myApp.constant('ConstantAlias', {}), myApp.config([
  '$routeProvider',
  '$httpProvider',
  function (e, n) {
    e.when('/dashboard', {
      ...
      for (n in e)
        if (r = e[n], r instanceof Array)
          for (s = 0; s < r.length; ++s)
            i = r[s], o = n + '[' + s + ']', l = {}, l[o] = i, u += t(l) + '&';
        else if (r instanceof Object)
          for (a in r)
            i = r[a], o = n + '[' + a + ']', l = {}, l[o] = i, u += t(l) + '&';
        else
          void 0 !== r && null !== r && (u += encodeURIComponent(n) + '=' + encodeURIComponent(r) + '&');
      return u.length ? u.substr(0, u.length - 1) : u;
    };
    n.defaults.transformRequest = [function (e) {
...
myApp.controller('DashboardCtrl', [
  '$scope',
  function (o) {
    o.welcome = 'Codeigniter with Angularjs';
  }
]);

myApp.factory('common', function (e, t) {
  return {
    http: {
      post: function (t, n) {
        return e.post(t, n);
    ...
    flashMsg: function (e, n) {
      ...
      $('.flashMsg').addClass(r);
      var o = $('.' + r);
      o.empty(), o.slideDown('slow'), o.html(n), t(function () {
        o.slideUp(1000), $('.flashMsg').removeClass(r);
      }, 4000);
    },
...
myApp.filter('formatDateWithTime', function () {
  function t(t, e) {
    if ('undefined' == typeof t || null === t)
      return '';
    var n = null, r = t.split(/[- :]/), u = new Date(r[0], r[1] - 1, r[2], r[3], r[4], r[5]), a = new Array('Jan', 'Feb', 'Mar', 'Apr', 'May', 'June', 'July', 'Aug', 'Sept', 'Oct', 'Nov', 'Dec'), h = new Array('th', 'st', 'nd', 'rd', 'th', 'th', 'th', 'th', 'th', 'th'), i = u.getDate(), o = u.getMonth(), l = u.getFullYear();
    i % 100 >= 11 && i % 100 <= 13 ? (n = i + 'th', n = i) : (n = i + h[i % 10], n = i);
    var m = u.getHours(), f = u.getMinutes(), p = m >= 12 ? 'pm' : 'am';
    m %= 12, m = m ? m : 12, f = f < 10 ? '0' + f : f;
    n = n < 10 ? '0' + n : n;
    var y = {
      day: n,
      month: a[o],
