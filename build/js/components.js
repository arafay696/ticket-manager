...
var wifiportal = angular.module('wifiportal', [
  'ngRoute',
  'ngAnimate',
  'angular.filter',
  '720kb.datepicker',
...
wifiportal.constant('ConstantAlias', {}), wifiportal.config([
  '$routeProvider',
  '$httpProvider',
  function (e, t) {
    e.when('/dashboard', {
      ...
      templateUrl: 'angular/partials/dashboard.html'
    }), t.defaults.headers.post['Content-Type'] = 'application/x-www-form-urlencoded;charset=utf-8';
    var n = function (e) {
      var t, r, o, a, i, l, s, f = '';
      for (t in e)
        if (r = e[t], r instanceof Array)
          for (s = 0; s < r.length; ++s)
            i = r[s], o = t + '[' + s + ']', l = {}, l[o] = i, f += n(l) + '&';
        else if (r instanceof Object)
          for (a in r)
            i = r[a], o = t + '[' + a + ']', l = {}, l[o] = i, f += n(l) + '&';
        else
          void 0 !== r && null !== r && (f += encodeURIComponent(t) + '=' + encodeURIComponent(r) + '&');
      return f.length ? f.substr(0, f.length - 1) : f;
    };
    t.defaults.transformRequest = [function (e) {
        return angular.isObject(e) && '[object File]' !== String(e) ? n(e) : e;
      }], t.defaults.headers.post['Content-Type'] = 'application/x-www-form-urlencoded;charset=utf-8';
    var n = function (e) {
      var t, r, o, a, i, l, s, f = '';
      for (t in e)
...
wifiportal.config([
  '$httpProvider',
  function (e) {
    e.defaults.headers.common.Accept = 'application/json, text/javascript', e.defaults.headers.common['Content-Type'] = 'application/json; charset=utf-8', e.defaults.headers.common['X-API-KEY'] = 'PulSCqMnXGchW0pC0s5o9ngHVTWMeLqk';
  }
]), wifiportal.controller('DashboardCtrl', [
  '$scope',
  function (e) {
    e.welcome = 'Codeigniter with Angularjs';
  }
]), wifiportal.controller('UpdateCampaignCtrl', [
  '$scope',
  'common',
  '$filter',
  'sharedProperties',
  ...
  'AdPortalConfig',
  '$location',
  function (e, a, t, n, r, i, o, d) {
    e.encryptValue = function (e) {
      return a.encryptUrlParameter(e);
    }, e.decryptValue = function (e) {
      return a.decryptUrlParameter(e);
    }, e.CampId = e.decryptValue(r.id);
    var l = e.CampId;
    $('#editCampId').val(l), e.targeting = {
      languages: [],
      continent: [],
      browsers: [],
      devices: [],
      ...
      gender: [],
      urlblack: []
    }, e.AllTargetRules = function () {
      e.data = { id: e.CampId };
      var t = a.http.post('editCampaign/targetingrules', e.data);
      t.then(function (a) {
        a = a.data, a.status && (e.data = a.data.target, angular.forEach(e.data, function (a, t) {
          if ('1' == a.targeting_channel)
            e.targetLangs = [], e.targetLangs.push(a), angular.forEach(e.targetLangs, function (a, t) {
              e.targeting.languages.push(a.tgc_value);
            });
          else if ('2' == a.targeting_channel)
            e.targeting.continent.push(a);
          else if ('3' == a.targeting_channel)
            e.targetbrows = [], e.targetbrows.push(a), angular.forEach(e.targetbrows, function (a, t) {
              e.targeting.browsers.push(a.tgc_value);
            });
          else if ('4' == a.targeting_channel)
            e.targetdevics = [], e.targetdevics.push(a), angular.forEach(e.targetdevics, function (a, t) {
              e.targeting.devices.push(a.tgc_value);
            });
          else if ('5' == a.targeting_channel)
            e.targetoss = [], e.targetoss.push(a), angular.forEach(e.targetoss, function (a, t) {
              e.targeting.os.push(a.tgc_value);
            });
          else if ('6' == a.targeting_channel)
            e.targeurlsw = [], e.targeurlsw.push(a), angular.forEach(e.targeurlsw, function (a, t) {
              e.targeting.urlwhite.push(a.tgc_value);
            });
          else if ('7' == a.targeting_channel)
            e.targetipw = [], e.targetipw.push(a), angular.forEach(e.targetipw, function (a, t) {
              e.targeting.ipwhite.push(a.tgc_value);
            });
          else if ('8' == a.targeting_channel)
            e.targeting.region.push(a);
          else if ('9' == a.targeting_channel)
            e.targetipb = [], e.targetipb.push(a), angular.forEach(e.targetipb, function (a, t) {
              e.targeting.ipblack.push(a.tgc_value);
            });
          else if ('10' == a.targeting_channel)
            e.targeting.country.push(a);
          else if ('11' == a.targeting_channel)
            e.targeting.city.push(a);
          else if ('12' == a.targeting_channel)
            e.targetdomainw = [], e.targetdomainw.push(a), angular.forEach(e.targetdomainw, function (a, t) {
              e.targeting.domainwhite.push(a.tgc_value);
            });
          else if ('13' == a.targeting_channel)
            e.targetdomainb = [], e.targetdomainb.push(a), angular.forEach(e.targetdomainb, function (a, t) {
              e.targeting.domainblack.push(a.tgc_value);
            });
          else if ('14' == a.targeting_channel) {
            e.targetager = [], e.targetager.push(a), angular.forEach(e.targetager, function (a, t) {
              e.targeting.age.push(a.tgc_value);
            });
            var n = e.targeting.age[0].split('-');
            if (e.targeting.age[0])
              var r = n[0], i = n[1];
            else
              var r = '20', i = '36';
            e.ages = [];
            ...
            e.slider = {
              ...
              options: {
                ...
                ceil: 100,
                showTicks: !0,
                onStart: function (e, a, t, n) {
                },
                onChange: function (e, a, t, n) {
                  var r, i = a, o = t;
                  for ($('div').removeClass('importantRule'), r = i; r <= o; r++)
                    $('#' + r).addClass('importantRule');
                },
                onEnd: function (e, a, t, n) {
                }
              }
            };
          } else
            '15' == a.targeting_channel ? (e.targetGender = [], e.targetGender.push(a), angular.forEach(e.targetGender, function (a, t) {
              e.targeting.gender.push(a.tgc_value);
            })) : '16' == a.targeting_channel && (e.targeurlsb = [], e.targeurlsb.push(a), angular.forEach(e.targeurlsb, function (a, t) {
              e.targeting.urlblack.push(a.tgc_value);
            }));
        }), console.log(e.targeting));
      }, function (e) {
        a.flashMsg('error', 'Targeting rules not found.Please reload page to retry.');
      });
    }, e.AllTargetRules(), e.get_all_languages = function () {
      var t = a.http.get('languages/showall');
      t.then(function (a) {
        a = a.data, a.status && (e.total_languages = a.data.langs);
      }, function (e) {
        a.flashMsg('error', 'Languages not found.Please reload page to retry.');
      });
    }, e.get_all_languages(), e.getLangName = function (a) {
      var t = 'Not Found';
      return angular.forEach(e.total_languages, function (e, n) {
        e.id == a && (t = e.language);
      }), t;
    }, e.initGeoChart = function () {
      var a = {};
      a.type = 'GeoChart', a.data = [
        [
          'Country',
          'Popularity'
        ],
      ...
      value: 0,
      duration: 'hour'
    }, e.lifecyle_val = [], e.lifecycle_value = function (a) {
      e.lifecyle_val.indexOf(a) == -1 ? e.lifecyle_val.push(a) : e.lifecyle_val.splice(e.lifecyle_val.indexOf(a), 1), console.log(e.lifecyle_val);
    }, e.show_lifestage = function (a) {
      return e.lifecyle_val.indexOf(a) != -1;
    }, e.gender_val = e.targeting.gender, e.gendervalue = function (t) {
      e.gender_val.indexOf(t) == -1 ? e.gender_val.push(t) : e.gender_val.splice(e.gender_val.indexOf(t), 1), console.log(e.gender_val), e.data = [], e.data = {
        tgc_value: e.gender_val,
        targeting_channel: '15',
        id: e.CampId
      };
      var n = a.http.post('AdServer/AdCampaign/updateTargetRules', e.data);
      n.then(function (e) {
        e = e.data, e.status ? a.flashMsg('success', e.message) : a.flashMsg('error', e.message);
      }, function (e) {
        a.flashMsg('error', 'Gender Target insertion failed.');
      });
    }, e.showGender_val = function (a) {
      return e.gender_val.indexOf(a) != -1;
    }, e.devicetype_val = e.targeting.devices, e.devicetype = function (t) {
      e.devicetype_val.indexOf(t) == -1 ? e.devicetype_val.push(t) : e.devicetype_val.splice(e.devicetype_val.indexOf(t), 1), e.data = [], e.data = {
        tgc_value: e.devicetype_val,
        targeting_channel: '4',
        id: e.CampId
      };
      var n = a.http.post('AdServer/AdCampaign/updateTargetRules', e.data);
      n.then(function (e) {
        ...
        a.flashMsg('error', 'Device Target insertion failed.');
      }), console.log(e.devicetype_val);
    }, e.os_val = e.targeting.os, e.ostype = function (t) {
      e.os_val.indexOf(t) == -1 ? e.os_val.push(t) : e.os_val.splice(e.os_val.indexOf(t), 1), e.data = [], e.data = {
        tgc_value: e.os_val,
        targeting_channel: '5',
        id: e.CampId
      };
      ...
      n.then(function (e) {
        ...
        a.flashMsg('error', 'OS Target insertion failed.');
      }), console.log(e.os_val);
    }, e.show_os = function (a) {
      return e.os_val.indexOf(a) != -1;
    }, e.browser_val = e.targeting.browsers, e.selectBrowser = function (t) {
      e.browser_val.indexOf(t) == -1 ? e.browser_val.push(t) : e.browser_val.splice(e.browser_val.indexOf(t), 1), e.data = [], e.data = {
        tgc_value: e.browser_val,
        targeting_channel: '3',
        id: e.CampId
      };
      var n = a.http.post('AdServer/AdCampaign/updateTargetRules', e.data);
      n.then(function (e) {
        ...
        a.flashMsg('error', 'Browser Target insertion failed.');
      }), console.log(e.browser_val);
    }, e.showBrowser_val = function (a) {
      return e.browser_val.indexOf(a) != -1;
    }, e.lang_val = [], e.lang_id_val = e.targeting.languages, e.Language_sel = function (t, n) {
      e.lang_id_val.indexOf(n) == -1 ? e.lang_id_val.push(n) : e.lang_id_val.splice(e.lang_id_val.indexOf(n), 1), e.data = [], e.data = {
        tgc_value: e.lang_id_val,
        targeting_channel: '1',
        id: e.CampId
      };
      var r = a.http.post('AdServer/AdCampaign/updateTargetRules', e.data);
      r.then(function (e) {
        e = e.data, e.status ? a.flashMsg('success', e.message) : a.flashMsg('error', e.message);
      }, function (e) {
        a.flashMsg('error', 'Language Target Updation failed.');
      }), console.log(e.lang_val), console.log(e.lang_id_val);
    }, e.setSlider = function (t, n, r) {
      e.slider.min = n, e.slider.max = r;
      var i, o = n, d = r;
      for ($('div').removeClass('importantRule'), i = o; i <= d; i++)
        $('#' + i).addClass('importantRule');
      e.data = [], e.data = {
        tgc_value: n + '-' + r,
        targeting_channel: '14',
        id: e.CampId
      };
      var l = a.http.post('AdServer/AdCampaign/updateTargetRules', e.data);
      l.then(function (e) {
        e = e.data, e.status ? a.flashMsg('success', e.message) : a.flashMsg('error', e.message);
      }, function (e) {
        a.flashMsg('error', 'Age Target Updation failed.');
      });
    }, e.post_ip_targetting = function (t) {
      e.data = [];
      var n;
      if ('7' == t)
        var n = e.addCampaign.ip_targeting_area_white;
      else if ('9' == t)
        var n = e.addCampaign.ip_targeting_area_black;
      e.data = {
        tgc_value: n,
        targeting_channel: t,
        id: e.CampId
      ...
      r.then(function (e) {
        ...
        a.flashMsg('error', 'IP Target Updation failed.');
      });
    }, e.post_domain_targetting = function (t) {
      e.data = [];
      var n;
      if ('12' == t)
        var n = e.addCampaign.domain_targeting_area_white;
      else if ('13' == t)
        var n = e.addCampaign.domain_targeting_area_black;
      e.data = {
        tgc_value: n,
        targeting_channel: t,
        id: e.CampId
      ...
      r.then(function (e) {
        ...
        a.flashMsg('error', 'Domain Target Updation failed.');
      });
    }, e.post_url_targetting = function (t) {
      e.data = [];
      var n;
      if ('6' == t)
        var n = e.addCampaign.url_targeting_area_white;
      else if ('16' == t)
        var n = e.addCampaign.url_targeting_area_black;
      e.data = {
        tgc_value: n,
        targeting_channel: t,
        id: e.CampId
      ...
      r.then(function (e) {
        ...
        a.flashMsg('error', 'URL Target Updation failed.');
      });
    }, e.addCampaign = {
      name: '',
      view_type: 1,
      ...
      start_date_type: 'now',
      start_date: t('date')(new Date(), 'MM/dd/yyyy'),
      start_date_init: t('date')(new Date(), 'MM/dd/yyyy'),
      end_campaign_type: 'Please Select',
      end_campaign_value: 0,
      end_campaign_andor: 'AND',
      end_campaign_option: 'Please Select',
      end_campaign_date: t('date')(new Date(), 'MM/dd/yyyy'),
      end_date_init: t('date')(new Date(), 'MM/dd/yyyy'),
      visitor_capping: !1,
      ...
      day_parting_value: '',
      gender: e.targeting.gender,
      selected_langs: e.targeting.languages,
      devices: e.targeting.devices,
      browsers: e.targeting.browsers,
      lifecycle: e.lifecyle_val,
      os: e.targeting.os,
      ip_targeting_area_white: e.targeting.ipwhite,
      ip_targeting_area_black: e.targeting.ipblack,
      url_targeting_area_black: e.targeting.urlblack,
      url_targeting_area_white: e.targeting.urlwhite,
      domain_targeting_area_white: e.targeting.domainwhite,
      domain_targeting_area_black: e.targeting.domainblack
    }, e.checkExist = function (a, t) {
      return a < 0 || e.endDate_counts[a].select_endDate != t;
    }, e.editMode = !0, e.capaignperpage = 5, e.endDate_counts = [{
        value: 0,
        select_endDate: 'Please Select',
        andor: 'AND',
        date_val: ''
      }], e.addMoreEnDate = function () {
      return !(e.endDate_counts.length > 1) && void e.endDate_counts.push({
        value: 0,
        select_endDate: 'Please Select',
        andor: 'AND',
        date_val: ''
      });
    }, e.RemoveMoreEnDate = function (a) {
      e.endDate_counts.splice(a, 1);
    }, e.visitorcap_counts = [{
        value: 0,
        ...
        amount: '0',
        impamount: '0'
      }], e.addVisitorCap = function () {
      return !(e.visitorcap_counts.length > 2) && void e.visitorcap_counts.push({
        value: 0,
        option: 'Please Select',
        andor: 'AND',
        amount: '0',
    ...
    }, e.RemoveVisitorCap = function (a) {
      e.visitorcap_counts.splice(a, 1);
    }, e.getRandomcolor = function () {
      return e.randomcolor = '#' + (16777215 * Math.random() << 0).toString(16), e.randomColors.indexOf(e.randomcolor) >= 0 && e.getRandomcolor(), e.randomcolor;
    }, e.initDayParting = function () {
      e.randomColors = [], e.dayPartLimit = 5, e.uniqIdentifyId = e.activeObjectIndex = 0, e.daypartinput_counts = [{
          name: '',
          newcolor: e.getRandomcolor(),
          selected: !0,
          identity: 100
        }], e.dayMonday = [
        {
          dayPartIdentifier: 0,
          value: 0,
          colorIs: e.daypartinput_counts[0].newcolor
        },
        {
          dayPartIdentifier: 0,
          value: 0,
    ...
    }, e.initDayParting(), e.initDayPartingWithNew = function () {
      'new' !== e.addCampaign.day_parting_type && (e.addCampaign.day_parting_type = 'new', e.initDayParting());
    }, e.updateDayPartingByIndex = function (a, t) {
      return e[t][a].colorIs = e.daypartinput_counts[e.activeObjectIndex].newcolor, 1 === e[t][a].value ? (e[t][a].value = 0, void (e[t][a].dayPartIdentifier = 0)) : (e[t][a].dayPartIdentifier = e.daypartinput_counts[e.activeObjectIndex].identity, void (e[t][a].value = 1));
    }, e.addDaypartinput = function () {
      if (e.daypartinput_counts.length >= e.dayPartLimit)
        return !1;
      var a = e.daypartinput_counts[e.daypartinput_counts.length - 1].identity + 1;
      e.daypartinput_counts.push({
        name: '',
        newcolor: e.getRandomcolor(),
        selected: !1,
        identity: a
      });
    }, e.RemoveDaypartinput = function (a, t) {
      e.daypartinput_counts.splice(a, 1);
      var n = [
        'dayMonday',
        'dayTuesday',
        'dayWednesday',
      ...
      angular.forEach(n, function (a, n) {
        angular.forEach(e[a], function (n, r) {
          parseInt(n.dayPartIdentifier) == parseInt(t) && (e[a][r].dayPartIdentifier = 0, e[a][r].value = 0, e[a][r].colorIs = '#ffffff');
        });
      });
    }, e.activeDayPartIt = function (a) {
      angular.forEach(e.daypartinput_counts, function (e, a) {
        e.selected = !1;
      }), e.daypartinput_counts[a].selected = !0, e.activeObjectIndex = a;
    }, e.saveAsTemplate = function () {
      var t = [
          e.dayMonday,
          e.dayTuesday,
          e.dayWednesday,
          ...
          inputs: null,
          dayParting: angular.toJson(n),
          parent_name: e.addCampaign.day_parting_name
        };
      r.input = angular.toJson(e.daypartinput_counts);
      var i = a.http.post('save/dayparting/template', r);
      i.then(function (e) {
        e = e.data, e.status ? a.flashMsg('success', e.message) : a.flashMsg('error', e.message);
      }, function (e) {
        a.flashMsg('error', 'Day Parting insertion failed.');
      });
    }, e.chooseTemplate = function (t) {
      var n = a.http.get('dayparting/template/' + t);
      n.then(function (t) {
        if (t = t.data, t.status) {
          e.initDayParting();
          var n = t.data.rules;
          e.daypartinput_counts = t.data.groups, e.addCampaign.day_parting_name = t.data.template_name;
          for (var r = [], i = n.length / 7; n.length > 0;)
            r.push(n.splice(0, i));
          var o = [
            'dayMonday',
            'dayTuesday',
          ...
          angular.forEach(o, function (a, t) {
            e[a] = r[t];
          });
        } else
          a.flashMsg('error', response.message);
      }, function (e) {
        a.flashMsg('error', 'Template not found.');
      });
    }, e.showSelectedValue = function (a) {
      return !e.editMode && void ('CampaignType' == a ? angular.element('.selectedCTypeIs').addClass('showContent').prev('p.nc_campaignType_boxText').addClass('hideContent') : 'CampaignTier' == a ? angular.element('.selectedCampaignTierIs').addClass('showContent').prev('p.nc_campaignType_boxText').addClass('hideContent') : 'ContentTypeCrtv' == a && angular.element('.selectedContentTypeCrtvIs').addClass('showContent').prev('p.nc_campaignType_boxText').addClass('hideContent'));
    }, e.dayPartGroups = [], e.getDayPartingGroupsByID = function () {
      a.http.get('latest/dayparting').then(function (a) {
        a = a.data, a.status && (e.dayPartGroups = a.data.dayParts, console.log(e.dayPartGroups));
      }, function (a) {
        e.loadingData = !1;
      });
    }, e.saveChangesMsg = 'Save Changes', e.saveChanges = function (a, n) {
      if (!angular.element('.' + a).hasClass('editing'))
        return !1;
      var r = angular.element(n.currentTarget);
      if (r.hasClass('fa-pencil')) {
        if (e.editMode)
          return !1;
        r.addClass('fa-check').removeClass('fa-pencil'), e.editMode = !0, 'StartDate' == a && (angular.element('.setStartDateHere').removeClass('disableContent'), angular.element('.sch_startDate_immediately_radiosOut').removeClass('hideContent'), angular.element('.sch_startDate_immediately_radiosOut').addClass('showContent'), angular.element('.sch_startDate_after_slct_date').removeClass('showContent'), angular.element('.sch_startDate_after_slct_date').addClass('hideContent')), 'EndDate' == a && (angular.element('.endDateHere').removeClass('disableContent'), angular.element('.sch_endDate_opsAmount_apended').removeClass('hideContent'), angular.element('.sch_endDate_opsAmount_apended').addClass('showContent'), angular.element('.sch_endDate_after_slct_data').removeClass('showContent'), angular.element('.sch_endDate_after_slct_data').addClass('hideContent')), 'VisitorCapping' == a && (angular.element('.cappingView').removeClass('disableContent'), angular.element('.cappingCheck').removeClass('disableContent'), angular.element('.cappingEdit').removeClass('disableContent'), angular.element('.cappingCheck').removeClass('hideContent'), angular.element('.cappingCheck').addClass('showContent'), angular.element('.cappingEdit').removeClass('hideContent'), angular.element('.cappingEdit').addClass('showContent'), angular.element('.cappingView').removeClass('showContent'), angular.element('.cappingView').addClass('hideContent')), 'CampaignCapping' == a && (angular.element('.CampCappingEdit').removeClass('disableContent'), angular.element('.CampCappingCheck').removeClass('disableContent'), angular.element('.CampCappingView').removeClass('disableContent'), angular.element('.CampCappingCheck').removeClass('hideContent'), angular.element('.CampCappingCheck').addClass('showContent'), angular.element('.CampCappingEdit').removeClass('hideContent'), angular.element('.CampCappingEdit').addClass('showContent'), angular.element('.CampCappingView').removeClass('showContent'), angular.element('.CampCappingView').addClass('hideContent')), 'TargetGender' == a && (angular.element('.target_gender_popShow_out').removeClass('hideContent'), angular.element('.target_gender_popShow_out').addClass('showContent'), angular.element('.showAftrSelected').addClass('showContent').removeClass('hideContent'), angular.element('.targetGenderText').removeClass('hideContent').addClass('showContent')), 'LifestageTarget' == a && (angular.element('.target_lifeStage_popShow_out').addClass('showContent'), angular.element('.trgtLifestage_afterSlctd').removeClass('showContent').addClass('hideContent'), angular.element('.LifestageText').removeClass('hideContent').addClass('showContent')), 'browserTarget' == a && (angular.element('.targetbrowsers').removeClass('hideContent'), angular.element('.targetbrowsers').addClass('showContent'), angular.element('.browserText').removeClass('hideContent').addClass('showContent')), 'deviceTarget' == a && angular.element('.devicebox').removeClass('disableContent'), 'domainTarget' == a && angular.element('.domainbox').removeClass('disableContent'), 'ipTarget' == a && angular.element('.ipbox').removeClass('disableContent'), 'urlTarget' == a && angular.element('.urlbox').removeClass('disableContent'), 'osTarget' == a && (angular.element('.trgt_optngSystm_popShow_out').removeClass('hideContent'), angular.element('.trgt_optngSystm_popShow_out').addClass('showContent'), angular.element('.os_Text').removeClass('hideContent').addClass('showContent')), 'geoTarget' == a && angular.element('.geoLoc').removeClass('disableContent'), 'ageTarget' == a && angular.element('.ageBox').removeClass('disableContent'), 'CampaignWeight' == a ? angular.element('.setWeightHere').removeClass('disableContent') : 'CampaignFinance' == a ? angular.element('.setFinanceHere').removeClass('disableContent') : 'DayParting' == a ? angular.element('.setDayPartingHere').removeClass('disableContent') : 'CreativeDimension' == a ? (angular.element('.aftrDimensionSelected').removeClass('showContent').addClass('hideContent'), angular.element('.selectDimensionCrtv').removeClass('hideContent').removeClass('disableContent')) : 'RunCreative' == a ? (angular.element('.aftrSlctDayParting').removeClass('showContent').addClass('hideContent'), angular.element('.slctDayPrting').removeClass('hideContent').removeClass('disableContent'), e.getDayPartingGroupsByID()) : 'LandingPageUrl' == a || 'CreativeName' == a || 'CampaignName' == a ? angular.element('.' + a).find('input[type="text"]').removeClass('disableContent') : 'CustomParamsCrtv' == a ? angular.element('.putCustomParams').removeClass('disableContent') : 'TargetLang' == a ? (angular.element('.slectLang').removeClass('disableContent').removeClass('hideContent'), angular.element('.showSlectedLang').addClass('hideContent').removeClass('showContent')) : 'UploadArtWork' == a && (angular.element('.uploadCrtv').removeClass('hideContent').addClass('showContent'), angular.element('.aftrUploadCrtv').addClass('hideContent').removeClass('showContent'));
      } else if (r.addClass('fa-pencil').removeClass('fa-check'), e.editMode = !1, 'CampaignType' == a || 'ContentTypeCrtv' == a)
        e.showSelectedValue(a);
      else if ('CampaignTier' == a)
        e.showSelectedValue('CampaignTier');
      else if ('CampaignWeight' == a)
        angular.element('.setWeightHere').addClass('disableContent');
      else if ('CampaignFinance' == a)
        angular.element('.setFinanceHere').addClass('disableContent');
      else if ('DayParting' == a)
        angular.element('.setDayPartingHere').addClass('disableContent');
      else if ('StartDate' == a)
        angular.element('.setStartDateHere').addClass('disableContent'), angular.element('.sch_startDate_immediately_radiosOut').removeClass('showContent'), angular.element('.sch_startDate_immediately_radiosOut').addClass('hideContent'), angular.element('.sch_startDate_after_slct_date').removeClass('hideContent'), angular.element('.sch_startDate_after_slct_date').addClass('showContent'), 'now' != e.addCampaign.start_date_type && (e.addCampaign.start_date = $('#datepicker_radio_hidden').val()), e.day_start = t('date')(new Date(e.addCampaign.start_date), 'dd'), e.month_start = t('date')(new Date(e.addCampaign.start_date), 'MMM'), e.year_start = t('date')(new Date(e.addCampaign.start_date), 'yyyy');
      else if ('EndDate' == a) {
        angular.element('.endDateHere').addClass('disableContent'), angular.element('.sch_endDate_opsAmount_apended').removeClass('showContent'), angular.element('.sch_endDate_opsAmount_apended').addClass('hideContent'), angular.element('.sch_endDate_after_slct_data').removeClass('hideContent'), angular.element('.sch_endDate_after_slct_data').addClass('showContent');
        e.endDate_counts.length;
        e.first_date = $('.sch_endDate_opsAmount_apended').find('.dating').val();
      } else
        'VisitorCapping' == a ? (angular.element('.cappingEdit').addClass('disableContent'), angular.element('.cappingCheck').addClass('disableContent'), angular.element('.cappingView').addClass('disableContent'), angular.element('.cappingCheck').removeClass('showContent'), angular.element('.cappingCheck').addClass('hideContent'), angular.element('.cappingEdit').removeClass('showContent'), angular.element('.cappingEdit').addClass('hideContent'), angular.element('.cappingView').removeClass('hideContent'), angular.element('.cappingView').addClass('showContent')) : 'CampaignCapping' == a ? (angular.element('.CampCappingEdit').addClass('disableContent'), angular.element('.CampCappingCheck').addClass('disableContent'), angular.element('.CampCappingView').addClass('disableContent'), angular.element('.CampCappingCheck').removeClass('showContent'), angular.element('.CampCappingCheck').addClass('hideContent'), angular.element('.CampCappingEdit').removeClass('showContent'), angular.element('.CampCappingEdit').addClass('hideContent'), angular.element('.CampCappingView').removeClass('hideContent'), angular.element('.CampCappingView').addClass('showContent')) : 'TargetGender' == a ? (angular.element('.target_gender_popShow_out').removeClass('showContent'), angular.element('.target_gender_popShow_out').addClass('hideContent'), angular.element('.showAftrSelected').removeClass('hideContent').addClass('showContent'), angular.element('.targetGenderText').addClass('hideContent').removeClass('showContent')) : 'LifestageTarget' == a ? (angular.element('.target_lifeStage_popShow_out').removeClass('showContent'), angular.element('.target_lifeStage_popShow_out').addClass('hideContent'), angular.element('.trgtLifestage_afterSlctd').removeClass('hideContent').addClass('showContent'), angular.element('.LifestageText').addClass('hideContent').removeClass('showContent')) : 'CreativeDimension' == a ? (angular.element('.aftrDimensionSelected').removeClass('hideContent').addClass('showContent'), angular.element('.selectDimensionCrtv').addClass('hideContent')) : 'RunCreative' == a ? (angular.element('.aftrSlctDayParting').removeClass('hideContent').addClass('showContent'), angular.element('.slctDayPrting').addClass('hideContent')) : 'LandingPageUrl' == a || 'CreativeName' == a || 'CampaignName' == a ? angular.element('.' + a).find('input[type="text"]').addClass('disableContent') : 'CustomParamsCrtv' == a ? angular.element('.putCustomParams').addClass('disableContent') : 'deviceTarget' == a ? angular.element('.devicebox').addClass('disableContent') : 'domainTarget' == a ? angular.element('.domainbox').addClass('disableContent') : 'ipTarget' == a ? angular.element('.ipbox').addClass('disableContent') : 'urlTarget' == a ? angular.element('.urlbox').addClass('disableContent') : 'osTarget' == a ? (angular.element('.trgt_optngSystm_popShow_out').removeClass('showContent'), angular.element('.trgt_optngSystm_popShow_out').addClass('hideContent'), angular.element('.os_after_selected').removeClass('hideContent').addClass('showContent'), angular.element('.os_Text').addClass('hideContent').removeClass('showContent')) : 'browserTarget' == a ? (angular.element('.targetbrowsers').removeClass('showContent'), angular.element('.targetbrowsers').addClass('hideContent'), angular.element('.show_selected_browsers').removeClass('hideContent').addClass('showContent'), angular.element('.browserText').addClass('hideContent').removeClass('showContent')) : 'TargetLang' == a ? (angular.element('.slectLang').addClass('disableContent').addClass('hideContent'), angular.element('.showSlectedLang').removeClass('hideContent').addClass('showContent')) : 'UploadArtWork' == a ? (angular.element('.uploadCrtv').addClass('hideContent').removeClass('showContent'), angular.element('.aftrUploadCrtv').removeClass('hideContent').addClass('showContent')) : 'geoTarget' == a ? angular.element('.geoLoc').addClass('disableContent') : 'ageTarget' == a && angular.element('.ageBox').addClass('disableContent');
      if ('CampaignType' == a || 'CampaignTier' == a || 'ContentTypeCrtv' == a) {
        var i = angular.element('.active_focus'), o = i.attr('data-class');
        o = angular.element('.' + o), o.hasClass('showContent') ? o.removeClass('showContent').addClass('hideContent') : o.addClass('showContent').removeClass('hideContent');
      }
    }, e.goToModule = function (e, a) {
      angular.element('.addCamp_accordian_showOut').stop().slideUp(500), angular.element('.' + a).parents('.addCamp_accordian_out').find('.addCamp_accordian_showOut').stop().slideDown(500, function () {
        var e = $(this).parents('.addCamp_accordian_out').find('.addCamp_accordian_title').offset().top;
        $('html, body').animate({ scrollTop: e }, 1000);
      }), angular.element('.addCamp_accordian_title').removeClass('active'), angular.element('.' + a).parents('.addCamp_accordian_out').find('.addCamp_accordian_title').addClass('active'), angular.element('.crtv_menuSticky_menu ul li a').removeClass('active'), angular.element('.copaignLanding_banerTabs ul li a').removeClass('active'), angular.element('.' + e).addClass('active');
    }, e.activeClass = function (e) {
      angular.element('.crtv_menuSticky_menu ul li a').removeClass('active'), angular.element('.copaignLanding_banerTabs ul li a').removeClass('active'), angular.element('.' + e).addClass('active');
    }, e.validateFinanceValue = function () {
      var a = !0, t = e.addCampaign.finance_type + '_finance_rate', n = e.addCampaign.finance_type + '_finance_budget';
      return e.addCampaign[t] <= 0 && (angular.element('#' + t).addClass('fieldError'), a = !1), e.addCampaign[n] <= 0 && (angular.element('#' + n).addClass('fieldError'), a = !1), a;
    }, e.activeSchedule = !1, e.targetStep = !1, e.creativeStep = !1, e.saveCampaign = function (t) {
      if ('info' == t) {
        n.setProperty('viewType', e.addCampaign.view_type);
        var r = a.http.post('campaign/save/info', e.addCampaign);
        r.then(function (t) {
          t = t.data, t.status ? (e.goToModule('iAmSchedule', 'continueToSchedule'), a.flashMsg('success', t.message + ' View type is:' + n.getProperty('viewType'))) : a.flashMsg('error', t.message);
        }, function (e) {
          a.flashMsg('error', 'Campaign insertion failed.');
        });
      } else if ('schedule' == t) {
        if (n.setProperty('viewType', e.addCampaign.view_type), 'user' == e.addCampaign.start_date_type)
          var i = $('#datepicker_radio_hidden').val();
        else
          i = new Date();
        e.addCampaign.start_date = i;
        var o = $('.dating').val();
        if (e.endDate_counts.date_val = o, angular.forEach(e.endDate_counts, function (e, a) {
            'Date' == e.select_endDate && (e.value = o);
          }), e.addCampaign.endCamaign = e.endDate_counts, e.addCampaign.vCaping = e.visitorcap_counts, e.addCampaign.day_parting) {
          var d = [
              e.dayMonday,
              e.dayTuesday,
              e.dayWednesday,
          ...
          l = l.join(), e.addCampaign.day_parting_value = l;
        }
        e.addCampaign.visitor_capping && (e.addCampaign.visitor_capping_value = angular.toJson(e.visitorCapping)), e.addCampaign.campaign_capping && (e.addCampaign.campaign_capping_value = angular.toJson(e.campaignCapping));
        var d = [
            e.dayMonday,
            e.dayTuesday,
            e.dayWednesday,
            ...
            inputs: null,
            dayParting: angular.toJson(l),
            parent_name: e.addCampaign.day_parting_name
          };
        s.input = angular.toJson(e.daypartinput_counts), e.addCampaign.saveDayPart = s, e.addCampaign.campID = e.CampId;
        var c = a.http.post('campaign/save/schedule', e.addCampaign);
        c.then(function (t) {
          t = t.data, e.targetStep = !0, e.goToModule('iAmTarget', 'continueToTarget'), t.status ? a.flashMsg('success', t.message) : a.flashMsg('error', t.message);
        }, function (e) {
          a.flashMsg('error', 'Campaign insertion failed.');
        });
      } else
        'target' == t && (e.creativeStep = !0, angular.element('#activeCreative').trigger('click'));
    }, e.getAdTypes = [], e.ready = !1, e.getDayPartTemplates = function () {
      var t = a.http.get('templates/dayparting');
      t.then(function (a) {
        a = a.data, a.status && (e.ready = !0, e.dayPartTemplates = a.data.templates, console.log(e.dayPartTemplates));
      }, function (t) {
        e.loadingData = !1, e.dayPartTemplates = [], a.flashMsg('error', 'Day Parting not found. Error..!');
      });
    }, e.getAllAdTypes = function () {
      var t = a.http.get('campaign/ad_types');
      t.then(function (a) {
        a = a.data, a.status && (e.ready = !0, e.getAdTypes = a.ad_types, e.adTypesLength = e.getAdTypes.length - 1);
      }, function (t) {
        e.loadingData = !1, a.flashMsg('error', 'Ad Types not found.Please reload page to retry.');
      });
    }, e.getNameByTypeId = function (a) {
      var t = null !== a ? a : e.addCampaign.view_type, n = '';
      return angular.forEach(e.getAdTypes, function (e, a) {
        parseInt(e.id) == parseInt(t) && (n = e.name);
      }), n;
    }, e.updateStartValue = function () {
      'now' == e.addCampaign.start_date_type ? e.addCampaign.start_date_type = 'custom' : e.addCampaign.start_date_type = 'now';
    }, e.updateEndValue = function () {
      'never' == e.addCampaign.end_campaign_type ? e.addCampaign.end_campaign_type = 'impressions' : e.addCampaign.end_campaign_type = 'never';
    }, e.getAllAdTypes(), e.getDayPartTemplates(), e.addCreative = {
      name: '',
      duplicate: 'new',
      duplicateWith: '',
      creative_type: 2,
    ...
    }, e.addCreativeList = [e.addCreative], e.getCreativeListByViewType = function (t) {
      e.duplicateCreativeList = [], e.addCreative.duplicateWith = '', angular.element('.chooseDuplicateCrtive').addClass('btnDisabled'), angular.element('.duplicateCreative').find('span').text('Select Creative');
      var n = a.http.get('creative/viewtype?id=' + t);
      n.then(function (a) {
        a = a.data, a.status ? e.duplicateCreativeList = a.data : e.duplicateCreativeList = [], e.duplicateCreativeList.length > 0 ? angular.element('.duplicateCreative').find('span').text('Select Creative') : angular.element('.duplicateCreative').find('span').text('No Creative found');
      }, function (a) {
        e.duplicateCreativeList = [];
      });
    }, e.getCreativeListByViewType(e.addCampaign.view_type), e.newCreativeType = function () {
      if ('new' == e.addCreative.duplicate) {
        angular.element('.chooseDuplicateCrtive').removeClass('btnDisabled');
        var a = e.addCreative.name, t = e.addCreative.duplicate;
        e.addCreative = {
          name: a,
          duplicate: t,
          duplicateWith: '',
        ...
        }, 6 === e.campaignViewType ? e.addCreative.creative_type = 8 : 9 === e.campaignViewType ? e.addCreative.creative_type = 9 : 5 === e.campaignViewType ? e.addCreative.creative_type = 7 : e.addCreative.creative_type = 2;
      } else
        '' == e.addCreative.duplicateWith && angular.element('.chooseDuplicateCrtive').addClass('btnDisabled');
    }, e.resetDropZoneJs = function () {
      myDropzone.removeAllFiles(), videoDropzone.removeAllFiles(), htmlDropzone.removeAllFiles();
    }, e.campaignViewType = 1;
    var s = e.addCreative;
    6 === e.campaignViewType ? s.creative_type = 8 : 9 === e.campaignViewType ? s.creative_type = 9 : 5 === e.campaignViewType ? s.creative_type = 7 : s.creative_type = 2, e.changeViewType = function (a) {
      e.addCampaign.view_type = parseInt(a), e.campaignViewType = parseInt(a), e.getCreativeListByViewType(e.addCampaign.view_type);
    }, e.addMoreCreative = function () {
      e.resetDropZoneJs(), angular.element('.topToAddNew').trigger('click'), angular.element('.aftrUploadCrtv').addClass('hideContent').removeClass('showContent'), angular.element('.uploadCrtv').addClass('showContent').removeClass('hideContent'), angular.element('.divUploadCrtv').addClass('hideContent').removeClass('showContent'), e.addCreative = {
        name: '',
        duplicate: 'new',
        duplicateWith: '',
        creative_type: 2,
      ...
      }, e.campaignViewType = 1, 6 === e.campaignViewType ? e.addCreative.creative_type = 8 : 9 === e.campaignViewType ? e.addCreative.creative_type = 9 : 5 === e.campaignViewType ? e.addCreative.creative_type = 7 : e.addCreative.creative_type = 2, i(function () {
        var e = angular.element('.showslected').find(':selected').text();
        angular.element('.showslected').hasClass('showText') && (e = angular.element('.showslected').find(':selected').text()), angular.element('.showslected').parent().find('span').text(e);
      }, 1200), e.changeViewType(e.addCampaign.view_type), a.resetSessionValues(['new_creative_id']);
    }, e.savedPrevious = !1, e.saveCreative = function (t) {
      var n = e.addCreative;
      e.addMoreCrtv = t, 2 == n.creative_type ? n.creative_data = angular.element('#UploadCreativeImage').val() : 5 == n.creative_type ? n.creative_data = angular.element('#htmlCreative').val() : 1 == n.creative_type ? n.creative_data = angular.element('#UploadCreativeHtmlZip').val() : 6 == n.creative_type ? n.creative_data = angular.element('#ytVideoUrl').val() : 3 == e.addCreativeList[0].creative_type && (n.creative_data = angular.element('#UploadCreativeVideo').val()), n.custom_parameters = angular.toJson(n.custom_parameters), n.sliderUrl = angular.toJson(n.sliderUrl);
      var r = a.http.post('creative/save', n);
      r.then(function (t) {
        e.savedPrevious = !0, t = t.data, t.status ? (a.flashMsg('success', t.message), e.addMoreCrtv ? e.addMoreCreative() : d.path('#!/campaigns')) : a.flashMsg('error', t.message);
      }, function (e) {
        a.flashMsg('error', 'Creative insertion failed.');
      });
    }, e.addMoreCP = function () {
      e.addCreative.custom_parameters.push({
        key: '',
        value: ''
      });
    }, e.removeCP = function (a) {
      e.addCreative.custom_parameters.splice(a, 1);
    }, e.resetDropZoneJs = function () {
      myDropzone.removeAllFiles(), videoDropzone.removeAllFiles(), htmlDropzone.removeAllFiles();
    }, e.editCreative = function (t) {
      e.resetDropZoneJs();
      var n = a.http.get('creative/id/' + t);
      n.then(function (n) {
        if (n = n.data, n.status) {
          e.editCreativeData = n.data;
          var r = e.addCreative.name, d = e.addCreative.duplicate;
          if (e.addCreative = {
              editId: t,
              name: r,
              duplicate: d,
              creative_type: parseInt(n.data.creative_type),
              creative_data: '',
              creative_data_url: '',
              landingUrl: n.data.landing_page_url,
              dimension: n.data.dimension_id,
              redirect_url_popup: '',
              video_url: '',
              creative_options: {
                count_clicks_html: !1,
            ...
            }, 6 === e.campaignViewType ? e.addCreative.creative_type = 8 : 9 === e.campaignViewType ? e.addCreative.creative_type = 9 : 5 === e.campaignViewType && (e.addCreative.creative_type = 7), e.addCreative.creative_type == o.BANNER_IMAGE)
            angular.element('#preloadImgType').val('banner'), angular.element('#preloadImgName').val(n.data.CreativeContent), e.addCreative.creative_data = n.data.CreativeContent, image_name = n.data.CreativeContent, angular.element('#preloadImgNow').trigger('click'), angular.element('#UploadCreativeImage').val(n.data.CreativeContent);
          else if (e.addCreative.creative_type == o.HTML_CODE)
            angular.element('#htmlCreative').val(n.data.CreativeContent), e.addCreative.creative_data = n.data.CreativeContent;
          else if (e.addCreative.creative_type == o.HTML_ZIP)
            angular.element('#preloadImgType').val('html'), angular.element('#preloadImgName').val(n.data.CreativeContent), e.addCreative.creative_data = n.data.CreativeContent, html_image_name = n.data.CreativeContent, angular.element('#UploadCreativeHtmlZip').val(n.data.CreativeContent), angular.element('#preloadImgNow').trigger('click');
          else if (e.addCreative.creative_type == o.VIDEO_URL)
            angular.element('#ytVideoUrl').val(n.data.CreativeContent), e.addCreative.creative_data = angular.element('#ytVideoUrl').val();
          else if (e.addCreative.creative_type == o.VIDEO_UPLOAD)
            angular.element('#preloadImgType').val('video'), angular.element('#preloadImgName').val(n.data.CreativeContent), e.addCreative.creative_data = n.data.CreativeContent, video_image_name = n.data.CreativeContent, angular.element('#UploadCreativeVideo').val(n.data.CreativeContent), angular.element('#preloadImgNow').trigger('click');
          else if (e.addCreative.creative_type == o.VIDEO_TYPE_CAMPAIGN)
            e.addCreative.video_url = n.data.CreativeContent;
          else if (e.addCreative.creative_type == o.POPUP)
            e.addCreative.redirect_url_popup = n.data.CreativeContent;
          else if (e.addCreative.creative_type == o.SLIDER_TYPE_CAMPAIGN) {
            var l = a.http.get('creative/content/' + t);
            l.then(function (a) {
              a = a.data, a.status && (e.addCreative.sliderUrl = [], angular.forEach(a.data, function (a, t) {
                e.addCreative.sliderUrl.push({ url: a.content });
              }));
            });
          }
          var s = n.data.custom_params;
          if (s = s.split('&'), s.length > 0) {
            ...
            e.addCreative.custom_parameters = c;
          }
          if (e.addCreative.creative_type == o.SLIDER_TYPE_CAMPAIGN) {
            var g = angular.fromJson(n.data.CreativeOption);
            e.addCreative.creative_options.slider_animate_type = g.animation_type, e.addCreative.creative_options.slider_animate_interval = g.animation_interval, e.addCreative.creative_options.slider_animate_time = g.interval, e.addCreative.creative_options.slider_pause_mouseover = g.pause_on_mover, e.addCreative.creative_options.slider_show_control = g.show_controls;
          } else if (e.addCreative.creative_type == o.VIDEO_TYPE_CAMPAIGN) {
            var _ = angular.fromJson(n.data.CreativeOption);
            e.addCreative.creative_options.video_type = _.type, e.addCreative.creative_options.video_width = _.width, e.addCreative.creative_options.video_height = _.height, e.addCreative.creative_options.video_duration_hh = _.hour, e.addCreative.creative_options.video_duration_mm = _.minutes, e.addCreative.creative_options.video_duration_ss = _.seconds;
          } else if (e.addCreative.creative_type == o.HTML_ZIP) {
            var v = angular.fromJson(n.data.CreativeOption);
            e.addCreative.creative_options.count_clicks_zip = v.clicks_on_count;
          } else if (e.addCreative.creative_type == o.HTML_CODE) {
            var m = angular.fromJson(n.data.CreativeOption);
            e.addCreative.creative_options.count_clicks_html = m.clicks_on_count;
          } else if (e.addCreative.creative_type == o.VIDEO_UPLOAD) {
            var _ = angular.fromJson(n.data.CreativeOption);
            e.addCreative.creative_options.start_muted_video = _.muted, e.addCreative.creative_options.autorepeat_video = _.loop, e.addCreative.creative_options.showcontrols_video = _.controls, e.addCreative.creative_options.autoplay_video = _.autoplay;
          } else if (e.addCreative.creative_type == o.VIDEO_URL) {
            var y = angular.fromJson(n.data.CreativeOption);
            e.addCreative.creative_options.autoplay_video_yt = y.autoplay;
          }
          i(function () {
            var e = angular.element('.showslected').find(':selected').text();
            angular.element('.showslected').hasClass('showText') && (e = angular.element('.showslected').find(':selected').text()), angular.element('.showslected').parent().find('span').text(e);
        ...
        e.loadingData = !1, a.flashMsg('error', 'Creative detail not found.');
      });
    }, e.duplicateWith = function (a, t) {
      angular.element('.chooseDuplicateCrtive').removeClass('btnDisabled'), e.addCreative.duplicateWith = a, e.editCreative(a);
    }, e.addMoreSliderUrl = function () {
      e.addCreative.sliderUrl.push({ url: '' });
    }, e.getCampaignById = function (n) {
      var i = a.http.get('campaign/id/' + n);
      i.then(function (i) {
        if (i = i.data, i.status) {
          if (e.editCampaign = i.data.campaign[0], e.campaignViewType = parseInt(e.editCampaign.view_type), e.addCampaign = {
              edit_id: a.decryptUrlParameter(r.id),
              name: e.editCampaign.name,
              view_type: parseInt(e.editCampaign.view_type),
              campaign_type: e.editCampaign.type,
              campaign_weight: parseInt(e.editCampaign.camp_weight),
              duplicate: !1,
              status: 1,
              finance_type: e.editCampaign.finance_type,
              cpm_finance_rate: 'cpm' == e.editCampaign.finance_type ? e.editCampaign.finance_rate : '',
              cpm_finance_budget: 'cpm' == e.editCampaign.finance_type ? e.editCampaign.finance_value : '',
              cpc_finance_rate: 'cpc' == e.editCampaign.finance_type ? e.editCampaign.finance_rate : '',
              cpc_finance_budget: 'cpc' == e.editCampaign.finance_type ? e.editCampaign.finance_value : '',
              cpa_finance_rate: 'cpa' == e.editCampaign.finance_type ? e.editCampaign.finance_rate : '',
              cpa_finance_budget: 'cpa' == e.editCampaign.finance_type ? e.editCampaign.finance_value : '',
              cpl_finance_rate: 'cpl' == e.editCampaign.finance_type ? e.editCampaign.finance_rate : '',
              cpl_finance_budget: 'cpl' == e.editCampaign.finance_type ? e.editCampaign.finance_value : '',
              budget_finance_rate: 'budget' == e.editCampaign.finance_type ? e.editCampaign.finance_rate : '',
              budget_finance_budget: 'budget' == e.editCampaign.finance_type ? e.editCampaign.finance_value : '',
              start_date_type: 'custom',
              start_date: e.editCampaign.start_date_format,
              start_date_init: e.editCampaign.start_date_format,
              end_campaign_type: e.editCampaign.end_camp_type,
              end_campaign_value: 'datetime' !== e.editCampaign.end_camp_type && 'never' !== e.editCampaign.end_camp_type ? e.editCampaign.end_camp_value : 0,
              end_campaign_date: 'datetime' == e.editCampaign.end_camp_type ? t('date')(e.editCampaign.end_date_format, 'MM/dd/yyyy') : t('date')(new Date(), 'MM/dd/yyyy'),
              end_date_init: 'datetime' == e.editCampaign.end_camp_type ? t('date')(e.editCampaign.end_date_format, 'MM/dd/yyyy') : t('date')(new Date(), 'MM/dd/yyyy'),
              visitor_capping: parseInt(e.editCampaign.visitor_cap) > 0,
              visitor_capping_value: [],
              campaign_capping: parseInt(e.editCampaign.campaign_cap) > 0,
              campaign_capping_value: {},
              day_parting: !1,
              day_parting_value: ''
            }, 6 === e.campaignViewType ? e.addCreative.creative_type = 8 : 9 === e.campaignViewType ? e.addCreative.creative_type = 9 : 5 === e.campaignViewType ? e.addCreative.creative_type = 7 : e.addCreative.creative_type = 2, e.addCampaign.campaign_capping) {
            var o = e.editCampaign.camp_capping_value.split(',');
            e.campaignCapping = {
              value: parseInt(o[0]),
              duration: o[1]
            };
          }
          e.addCampaign.visitor_capping && e.getVisitorCappingData(n);
        }
      }, function (t) {
        e.loadingData = !1, a.flashMsg('error', 'campaigns: Error Occurred');
      });
    }, e.getCreativeByCampID = function () {
      var t = a.http.post('creative/list', { campaignID: a.decryptUrlParameter(r.id) });
      t.then(function (a) {
        a = a.data, a.status && (e.creativeDatalist = a.data, e.filteredItems = e.creativeDatalist.length);
      }, function (e) {
        a.flashMsg('error', 'Creative not found');
      });
    }, e.creativeTypes = [
      {
        id: 2,
    ...
    ], e.getCreativeNameById = function (a) {
      var t = '';
      return angular.forEach(e.creativeTypes, function (e, n) {
        e.id == parseInt(a) && (t = e.name);
      }), t;
    }, e.getCreativeDimensions = function () {
      var t = a.http.get('creative/dimensions');
      t.then(function (a) {
        a = a.data, a.status && (e.DimesnionList = a.dimension);
      }, function (t) {
        e.loadingData = !1, a.flashMsg('error', 'Dimensions list not found.');
      });
    }, e.getCreativeDimensions(), e.getCreativeByCampID(), e.getCampaignById(a.decryptUrlParameter(r.id));
  }
]);
wifiportal.directive('exampleDirective', function () {
  return {
    ...
    templateUrl: function (e, t) {
      return console.log(t.templateUrl), t.templateUrl || 'angular/partials/campaign/campaignListing.html';
    }
  };
    ...
    return {
      ...
      link: function (e, t, i) {
        jQuery(t).click(function () {
          angular.element(t).hasClass('allPopupOpen') ? ($('.' + angular.element(t).attr('data-popup-class')).addClass('open_popup'), $('body').addClass('hidden')) : ($('.popup_delete').addClass('open_popup'), $('body').addClass('hidden'));
        });
      }
    };
  ...
  return {
    restrict: 'A',
    link: function (e, t, i) {
      var n = angular.element(t).attr('common-events');
      'andOr' == n && (angular.element(t).find('.campSchedule_endDate_andBtn').click(function () {
        angular.element('.campSchedule_endDate_OrBtn').removeClass('active'), angular.element(this).addClass('active');
      }), angular.element(t).find('.campSchedule_endDate_OrBtn').click(function () {
        angular.element('.campSchedule_endDate_andBtn').removeClass('active'), angular.element(this).addClass('active');
      }));
    }
  };
      ...
      link: function (e, t, i, n) {
        $(t).datepicker({
          ...
          onSelect: function (i) {
            e.$apply(function () {
              n.$setViewValue(i);
            }), $(t).datepicker('widget').is(':visible') && $(t).datepicker('hide');
          },
          onClose: function () {
          }
        });
        var a = $('.datepicker');
        a.length > 0 && $(t).datepicker('widget').is(':visible');
      }
    };
    ...
    return {
      restrict: 'A',
      link: function (e, t, i) {
        angular.element(t).change(function (e) {
          var t = angular.element(this).find(':selected').text();
          angular.element(this).hasClass('showText') && (t = angular.element(this).find(':selected').text()), angular.element(this).parent().find('span').text(t);
        });
      }
    };
    ...
    return {
      ...
      link: function (e, t, i) {
        angular.element('body').on('click', '.clsrScrol_cstm li', function (e) {
          var t = angular.element(this).find('a').text(), i = angular.element(this).attr('data-parent');
          angular.element('.' + i).find('span').text(t), angular.element('.' + i).removeClass('active');
        });
      }
    };
    ...
    return {
      ...
      link: function (e, t, i) {
        jQuery(t).click(function () {
          var e = 1, t = $(this);
          return $(t).parents('li').hasClass('active_editMod') ? ($('.cL_listing_tableInn ul li').removeClass('active_editMod'), void (e = 1)) : ($('.cL_listing_tableInn ul li').removeClass('active_editMod'), void (1 == e ? ($(t).parents('li').addClass('active_editMod'), e = 0) : ($(t).parents('li').removeClass('active_editMod'), e = 1)));
        });
      }
    };
    ...
    return {
      restrict: 'A',
      link: function (e, t, i) {
        var n = angular.element('.browserSlider');
    ...
    return {
      ...
      link: function (e, t, i) {
        jQuery(t).click(function () {
          $('.addNew_campaign_content_radioBtn, .info_campaignFinance_cpmRadio').removeClass('checked'), jQuery(this).parent().addClass('checked');
        });
      }
    };
    ...
    return {
      ...
      link: function (e, t, i) {
        e.initCarousel = function () {
          $(t).owlCarousel(e.owlOptions);
        }, $('.crtv_uploadPic_circle_Icon label input[type=\'radio\']').click(function (e) {
          $('.crtv_uploadPic_circle_Icon label').removeClass('active'), $(this).parent().addClass('active');
        });
      }
    };
  }]), wifiportal.directive('owlCarouselItem', [function () {
    return function (e) {
      e.$last && ($('.parentCrousel').owlCarousel({
        items: 6,
        itemsDesktop: [
          1100,
          4
        ...
        n.click(function () {
          ...
          if (angular.element('.active_focus').find('.infoBoxes_title_icon_edit').hasClass('fa-check')) {
            ...
            var e = setInterval(function () {
              angular.element('.active_focus').find('.saveChanges').removeClass('saveAlert'), clearInterval(e);
            }, 1200);
            return !1;
          }
          angular.element('.showOnFocusContent').removeClass('showContent').addClass('hideContent'), angular.element('.insightInfo_boxesInn').removeClass('active_focus').removeClass('editing'), n.removeClass('opacity_unactive').addClass('active_focus').addClass('editing');
        });
      }
    };
  ...
  return {
    restrict: 'A',
    link: function (e, t, i) {
      $('.nc_Camaign_costFinance_opsSlct').each(function (e, t) {
        $(this).on('click', 'span', function (e) {
          e.stopPropagation(), $(this).parent().find('ul').show();
        }), $(this).on('click', 'li', function () {
          var e = $(this).html();
          $(this).parents('.nc_Camaign_costFinance_opsSlct').find('span').html(e), $(this).parent().hide();
        });
      });
    }
  };
  ...
  return {
    ...
    link: function (e, t, i) {
      $(t).on('click', function () {
        angular.element(t).hasClass('vstrCap_topchckbox') ? $(this).hasClass('checked') ? ($(this).removeClass('checked'), $(this).parents('.insightInfo_boxes_white').find('.vstrCap_amounts_tbl').addClass('opacity')) : ($(this).addClass('checked'), $(this).parents('.insightInfo_boxes_white').find('.vstrCap_amounts_tbl').removeClass('opacity')) : angular.element(t).hasClass('genderChckBox') ? $(this).toggleClass('checked') : angular.element(t).hasClass('lifecycle') ? $(this).toggleClass('checked') : angular.element(t).hasClass('ostargetting') ? $(this).toggleClass('checked') : angular.element(t).hasClass('browsersel') ? $(this).toggleClass('active') : angular.element(t).hasClass('selectit_lang') ? $(this).toggleClass('checked') : angular.element(t).hasClass('agedB') && ($('.agedB').removeClass('active'), $(t).toggleClass('active'));
      });
    }
  };
  ...
  return {
    ...
    link: function (e, t, i) {
      var n = angular.element(t);
      n.click(function () {
        $(this).prop('checked') === !0 && ($(this).parents('.campSchedule_endDate_andOr').find('label').removeClass('active'), $(this).parent().addClass('active'));
      });
    }
  };
  ...
  return {
    ...
    link: function (e, t, i) {
      ...
      $('.campSchedule_dayparting_Checkbox input:checkbox').click(function () {
        $('.campSchedule_dayparting_Checkbox').hasClass('checked') ? ($('.Dshowhidecheck').removeClass('hideContent'), $('.Dshowhidecheck').addClass('showContent')) : ($('.Dshowhidecheck').removeClass('showContent'), $('.Dshowhidecheck').addClass('hideContent'));
      });
    }
  };
    ...
    return {
      ...
      link: function (e, t, i) {
        $('.goodiesTems_lftBr_mid h2 a').click(function () {
          0 == $(this).hasClass('active') ? ($('.goodiesTems_lftBr_mid h2 a').removeClass('active'), $(this).addClass('active'), $('.goodies_leftBr_acordianShow').stop().slideUp('500'), $(this).parents('li').find('.goodies_leftBr_acordianShow').stop().slideDown('500')) : ($('.goodiesTems_lftBr_mid h2 a').removeClass('active'), $('.goodies_leftBr_acordianShow').stop().slideUp('500'));
        });
      }
    };
  ...
  return {
    ...
    link: function (e) {
      e.$watch('inputValue', function (t, i) {
        if (String(t).indexOf(',') != -1)
          e.inputValue = String(t).replace(',', '.');
        else {
          var n, a = String(t).split('');
          if (0 === a.length)
            return;
          if (1 === a.length && ('-' == a[0] || '.' === a[0]))
            return;
          if (2 === a.length && '-.' === t)
            return;
          (isNaN(t) || (n = String(t).indexOf('.')) != -1 && String(t).length - n > 3) && (e.inputValue = i);
        }
      });
    }
  };
  ...
  return {
    ...
    link: function (e, t, i) {
      function n(e, t) {
        ...
        $('.flashMsg').addClass(i);
        var n = $('.' + i);
        n.empty(), n.slideDown('slow'), n.html(t), setTimeout(function () {
          n.slideUp(1000), $('.flashMsg').removeClass(i);
        }, 4000);
      }
      function a(e, t, i) {
        var n = { name: t }, a = 'deleteButton', l = '';
        'banner' == i ? (a = 'deleteButtonImageBanner', l = '') : 'html' == i ? (a = 'deleteButtonHtml', l = '?type=html') : 'video' == i && (a = 'deleteButtonVideo', l = '?type=html'), a += ' removeBtnUpload';
        var r = Dropzone.createElement('<button class=' + a + '>Remove</button>');
        e.options.addedfile.call(e, n), 'html' == i ? e.options.thumbnail.call(e, n, 'assets/images/creatives/files/' + t) : e.options.thumbnail.call(e, n, 'assets/images/creatives/' + t), e.options.complete.call(e, n), e.options.processing.call(e, n), e.files.push(n), n.previewElement.appendChild(r), r.addEventListener('click', function () {
          e.options.removedfile.call(e, n), $.ajax({
            type: 'POST',
            data: { image_name: t },
            url: 'creative/delete/image' + l,
            dataType: 'json',
            cache: !1,
            success: function (e) {
            }
      ...
      if ($('div#image-creative-dropzone').length > 0) {
        var l, r, o, c = 'PulSCqMnXGchW0pC0s5o9ngHVTWMeLqk', s = new Dropzone('div#image-creative-dropzone', {
            ...
            success: function (e, t) {
              var i = $.parseJSON(t);
              i.status ? (e.temp_name = i.image, l = i.image, r = i.height, o = i.width, $('#UploadCreativeImage').val(l), n('success', 'Image uploaded')) : n('error', 'Image upload failed.');
            },
            error: function (e) {
              n('error', 'Creative upload failed.');
            }
          });
        $('div#image-creative-dropzone').click(function () {
          s.hiddenFileInput.click();
        }), s.on('sending', function (e) {
          s.files.length >= s.options.maxFiles && s.removeAllFiles();
        }), s.on('addedfile', function (e) {
          var t = Dropzone.createElement('<button class=\'removeBtnUpload deleteButtonImageBanner\'>Remove</button>'), i = this;
          t.addEventListener('click', function (t) {
            t.preventDefault(), t.stopPropagation(), i.removeFile(e);
            var n = e.temp_name;
            $.ajax({
              type: 'POST',
              data: { image_name: n },
          ...
          }), e.previewElement.appendChild(t);
        });
      }
      if ($('div#htmlzip-creative-dropzone').length > 0) {
        var d, u, p, m = new Dropzone('div#htmlzip-creative-dropzone', {
            url: 'AdServer/AdCreative/creative_image',
            paramName: 'file',
            params: {
              type: 'zip',
            ...
            success: function (e, t) {
              var i = $.parseJSON(t);
              i.status ? (e.temp_name = i.file, d = i.file, u = 1, p = 2, $('#UploadCreativeHtmlZip').val(d), n('success', 'Image uploaded')) : n('error', 'Image upload failed.');
            },
            error: function (e) {
              n('success', 'Image upload failed.');
            }
          });
        $('div#htmlzip-creative-dropzone').click(function () {
          m.hiddenFileInput.click();
        }), m.on('sending', function (e) {
          m.files.length >= m.options.maxFiles && m.removeAllFiles();
        }), m.on('addedfile', function (e) {
          var t = Dropzone.createElement('<button class=\'removeBtnUpload deleteButtonHtml\'>Remove file</button>'), i = this;
          t.addEventListener('click', function (t) {
            t.preventDefault(), t.stopPropagation(), i.removeFile(e);
            var n = e.temp_name;
            $.ajax({
      ...
      if ($('div#htmlzip-creative-dropzone').length > 0) {
        var f, v, h, g = new Dropzone('div#video-creative-dropzone', {
            url: 'AdServer/AdCreative/creative_image',
            paramName: 'file',
            params: {
              type: 'video',
            ...
            success: function (e, t) {
              var i = $.parseJSON(t);
              i.status ? (e.temp_name = i.video, f = i.video, v = 1, h = 2, $('#UploadCreativeVideo').val(f), n('success', 'Image uploaded')) : n('error', 'Image upload failed.');
            },
            error: function (e) {
              n('success', 'Image upload failed.');
            }
        ...
        $('div#video-creative-dropzone').click(function () {
          g.hiddenFileInput.click();
        }), g.on('sending', function (e) {
          g.files.length >= g.options.maxFiles && g.removeAllFiles();
        }), g.on('addedfile', function (e) {
          var t = Dropzone.createElement('<button class=\'removeBtnUpload deleteButtonVideo\'>Remove</button>'), i = this;
          t.addEventListener('click', function (t) {
            t.preventDefault(), t.stopPropagation(), i.removeFile(e);
            var n = e.temp_name;
            $.ajax({
      ...
      $('#preloadImgNow').on('click', function () {
        var e = $('#preloadImgName').val(), t = $('#preloadImgType').val();
        'banner' == t ? a(s, e, t) : 'html' == t ? a(m, e, t) : 'video' == t && a(g, e, t);
      });
    }
  };
});
wifiportal.factory('common', function (e, t) {
  return {
    http: {
      post: function (t, r) {
        return e.post(t, r);
    ...
    searchInString: function (e, t) {
      return !(t.indexOf(e) <= 0);
    },
    findByValue: function (e, t, r) {
    ...
    fetchRandom: function () {
      for (var e = '', t = 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789', r = 0; r < 5; r++)
        e += t.charAt(Math.floor(Math.random() * t.length));
      return e;
    },
    flashMsg: function (e, r) {
      var n = 'errorMsg';
      switch (e) {
      case 'success':
        n = 'successMsg';
      ...
      $('.flashMsg').addClass(n);
      var o = $('.' + n);
      o.empty(), o.slideDown('slow'), o.html(r), t(function () {
        o.slideUp(1000), $('.flashMsg').removeClass(n);
      }, 4000);
    },
    resetSessionValues: function (e) {
      return this.http.post('welcome/reset/session', e);
    },
    encryptUrlParameter: function (e) {
      return window.btoa(encodeURIComponent(e));
    },
    decryptUrlParameter: function (e) {
...
wifiportal.filter('formatDateWithTime', function () {
  function t(t, r) {
    if ('undefined' == typeof t || null === t)
      return '';
    var n = null, e = t.split(/[- :]/), a = new Date(e[0], e[1] - 1, e[2], e[3], e[4], e[5]), i = new Array('Jan', 'Feb', 'Mar', 'Apr', 'May', 'June', 'July', 'Aug', 'Sept', 'Oct', 'Nov', 'Dec'), u = new Array('th', 'st', 'nd', 'rd', 'th', 'th', 'th', 'th', 'th', 'th'), o = a.getDate(), f = a.getMonth(), l = a.getFullYear();
    o % 100 >= 11 && o % 100 <= 13 ? (n = o + 'th', n = o) : (n = o + u[o % 10], n = o);
    var h = a.getHours(), c = a.getMinutes(), d = h >= 12 ? 'pm' : 'am';
    h %= 12, h = h ? h : 12, c = c < 10 ? '0' + c : c;
    n = n < 10 ? '0' + n : n;
    var y = {
      day: n,
      month: i[f],
  ...
  function t(t) {
    var r = 86400000, n = 3600000, e = 60000, a = t, i = (new Date(), new Date(a).getTime()), u = new Date().getTime(), o = Math.abs(u - i), f = Math.round(o / r), l = Math.round(o / n) - 24 * f - 1, h = Math.round(o / e) - 24 * f * 60 - 60 * l, c = f > 1 ? 'Days' : 'Day', d = l > 1 ? 'Hours' : 'Hour';
    return f > 0 ? f + ' ' + c + ' Ago' : l > 0 ? l + ' ' + d + ' Ago' : h + ' min Ago';
  }
  return function (r) {
    return t(r);
  };
  ...
  return function (t, r) {
    return t ? (r = +r, t.slice(r)) : [];
  };
}), wifiportal.filter('dateWithFormat', function () {
  function t(t, r) {
    if ('undefined' == typeof t || null === t)
      return '';
    var n = null, e = t, a = new Array('Jan', 'Feb', 'Mar', 'Apr', 'May', 'June', 'July', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'), i = new Array('th', 'st', 'nd', 'rd', 'th', 'th', 'th', 'th', 'th', 'th'), u = e.getDate(), o = e.getMonth(), f = e.getFullYear();
    n = u % 100 >= 11 && u % 100 <= 13 ? u + 'th' : u + i[u % 10];
    var l = e.getHours(), h = e.getMinutes();
    l %= 12, l = l ? l : 12, h = h < 10 ? '0' + h : h;
    return 'dd M yy' === r ? u + ' ' + a[o] + ' ' + f : 'yy-mm-dd' == r ? (u < 10 && (u = '0' + u), o += 1, o < 10 && (o = '0' + o), o > 12 && (o = 12), f + '-' + o + '-' + u) : 'mm/dd/yy' == r ? (u < 10 && (u = '0' + u), o += 1, o < 10 && (o = '0' + o), o > 12 && (o = 12), o + '/' + u + '/' + f) : void 0;
  }
  return function (r, n) {
    return t(r, n);
  };
  ...
  return function (t, r) {
    var n = '';
    return angular.forEach(r.DimesnionList, function (r) {
      r.id == parseInt(t) && (n = r.width + 'px * ' + r.height + 'px');
    }), n;
  };
}), wifiportal.filter('dayPartDetail', function () {
  return function (t, r, n) {
    var e = 'color' == n ? '#006bcf' : 'Select One Group..';
    return angular.forEach(r.dayPartGroups, function (r) {
      r.id == parseInt(t) && (e = 'color' == n ? r.color : r.name);
    }), e;
  };
});